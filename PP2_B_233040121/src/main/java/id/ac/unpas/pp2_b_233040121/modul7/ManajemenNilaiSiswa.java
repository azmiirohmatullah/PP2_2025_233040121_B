 ...
 */
package id.ac.unpas.pp2_b_233040121.modul7;
...
public class ManajemenNilaiSiswa extends JFrame {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new ManajemenNilaiSiswa().setVisible(true);
        });
    }
